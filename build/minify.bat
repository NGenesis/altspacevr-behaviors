...
copy /b common.js + browsershims.js + TWEEN.js + NativeComponent.js + OrbitControls.js + UserEvents.js + PreloadNativeSounds.js + TransformControls.js + HoverMaterialColor.js + HoverMaterialOpacity.js + NativeTextMaterial.js altspaceutil.js
